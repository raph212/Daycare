...
export default function LoginPage({ onBack, onOtp, role, setRole }) {
  ...
  <button onClick={() => onOtp(role)} className="w-full bg-orange-400 text-white font-semibold py-3 rounded-xl hover:bg-orange-500 transition-colors mb-4">
    Send OTP
  </button>
